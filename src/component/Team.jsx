...
const Team = () => {
    return (
        <section className='team-bg py-5'>
                ...
                <div className="row">
                    <div className="col-6">
                        <div className='d-flex'>
                            ...
                            <div className='mt-5 mx-3'>
                                ...
                                <p className='profile-subdes'>CEO / CO-FOUNDER</p>
                                <div className=''>
                                    <p className='profile-des mt-3'>Lorem ipsum dolor sit amet, consetet <br /> sadipscing elitr, sed diam nonumy <br /> eirmod tempor invidunt ut labore et <br /> dolore magna aliquyam.</p>
                                </div>
                             <div className='team-icon'>
                                    <ul className='icon1 ps-0 d-flex'>
                    ...
                    <div className="col-6">
                        <div className='d-flex'>
                            ...
                            <div className='mt-5 mx-3'>
                                <h3 className='profile-name'>Gregory Simmons</h3>
                                <p className='profile-subdes'>CEO / CO-FOUNDER</p>
                                <div className=''>
                                    <p className='profile-des mt-3'>Lorem ipsum dolor sit amet, consetet <br /> sadipscing elitr, sed diam nonumy <br /> eirmod tempor invidunt ut labore et <br /> dolore magna aliquyam.</p>
                                </div>
